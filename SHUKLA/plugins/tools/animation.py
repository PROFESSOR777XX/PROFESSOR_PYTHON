...
async def hajqag(client: Client, message: Message):
    ...
    animation_chars = [
        ...
        f"`Me:  ᴍᴇ ʜᴜɴ ᴛᴇʀᴀ` {DEFAULTUSER} ,`ᴍᴜᴛʜᴇ    4ˢᵗ➳𝐏ʀᴏғᴇssᴏʀ🍃 ᴋɪ ɢᴀɴᴅ ᴍᴀʀɴɪ ʜᴀɪ..😁😁`",
        "`User Authorised.`",
        "`Calling ㅤ 4ˢᵗ➳𝐏ʀᴏғᴇssᴏʀ🍃`  `At +916969696969`",
        "`Private  Call Connected...`",
        "`Me: Hello ᴍᴄ, 4ˢᵗ➳𝐏ʀᴏғᴇssᴏʀ🍃...ᴛᴇʀɪ ᴍᴀ ᴋɪ ᴄʜᴜᴛ...🤣🤣😂.`",
        "ㅤ 4ˢᵗ➳𝐏ʀᴏғᴇssᴏʀ🍃 :ᴏᴋᴀʏ sɪʀ ʙᴜᴛ ᴘᴇʜʟᴇ #_4sᴛ ᴋᴀ ʙᴇᴛᴀ ᴋᴏɴ ʜᴀɪ ᴛᴜ?...😎`",
        f"`Me: ᴀʙᴇ ᴢʜᴀᴛᴜ, I Am` {DEFAULTUSER} ",
        "`ㅤ 4ˢᵗ➳𝐏ʀᴏғᴇssᴏʀ🍃 : ᴀʙᴇ ғᴀᴛᴇ ʜᴜʏᴇ ᴄᴏɴᴅᴀᴍ ᴋᴇ ɴᴀᴛɪᴊᴇ...🤣🤣\nʙsᴅᴋᴇ ɢʜᴀʀ ᴍᴇ ɢʜᴜsᴋᴇ ᴛᴇʀɪ ᴀᴍᴍᴀ ʙᴇʜᴇɴ ᴋᴀ ʀᴇᴘ ᴋᴀʀᴅᴜɴɢᴀ ᴢʜᴀᴛᴜ😜.`",
        "`Me: ᴀʙᴇ ʙsᴅᴋᴇ... ᴛᴇʟᴇɢʀᴀᴍ #_4sᴛ ᴋᴏ ᴄʜᴀʟᴀ ʀᴀʜᴀ ᴋɪ #_4sᴛ ᴛᴇʟᴇɢʀᴀᴍ ᴋᴏ ᴄʜᴀʟᴀ ʀᴀʜɪ...?😜.`",
        "`ㅤ 4ˢᵗ➳𝐏ʀᴏғᴇssᴏʀ🍃 : ʙᴇᴛᴇ...!! ɴᴀᴀ ᴊᴀᴍɪɴ ᴘᴇ ɴᴀ ᴀᴀsᴍᴀɴ ᴘᴇ...😉😉 ᴛᴇʀɪ ᴍᴀʏʏᴀ ᴋᴏ ᴄʜʜᴏᴅᴜɴɢᴀ ᴍᴇ #_4sᴛ ᴋᴇ ᴍᴀᴋᴋᴀɴ ᴘᴇ...🥵🥵.`",
        "`Me: ʙʜᴀɪ...ʏᴀᴀʀ ᴍᴇʀɪ ɢᴀᴀɴᴅ ᴍᴀʀᴏ ʙᴜᴛ ᴍᴜᴊʜᴇ ᴍᴀғ ᴋᴀʀᴏ...🤯`",
        "`ㅤ 4ˢᵗ➳𝐏ʀᴏғᴇssᴏʀ🍃 : ʜɪʜɪʜɪ... ʏᴇ ʜᴜɪ ɴᴀ ʙᴀᴀᴛ....😁😁\nᴄʜᴀʟ ᴀᴀʙ ᴀᴀᴘɴɪ ʀᴀɴᴅɪ ᴍᴀʏʏᴀ ᴋᴏ #_4sᴛ ᴋᴇ ᴠᴄ ᴘᴇ ʙᴜʟᴀ ᴋɪ ᴄʜᴜᴛ ᴅɪᴋʜᴀɴᴇ ᴋᴏ ʙᴏʟ😛😛.`",
        "`Me: ʙʜᴀɪ ᴘʟᴢ ɢᴀʟɪ ᴍᴛ ᴅᴏ😥.`",
        "`ㅤ 4ˢᵗ➳𝐏ʀᴏғᴇssᴏʀ🍃 : ᴛᴏ #_4sᴛ ᴋᴏ ʙᴀᴀᴘ ʙᴏʟ ᴀᴜʀ...ᴄʜᴀʟ ʙʜᴀɢ ʏᴀʜᴀ sᴇ ᴍᴄ..ʙsᴅᴋᴇ ᴋᴇ ᴘʜɪʀ ᴄᴀʟʟ ᴋɪʏᴀ ᴛᴏ #_4sᴛ ᴋɪ ᴠᴄ ᴘᴇ ᴛᴇʀɪ ᴍᴀʏʏᴀ ᴋᴏ ɴᴀɴɢᴀ ᴋᴀᴜɴɢ..🤣🤣  \n🙈𝐓ɢ 𝐏ᴇ 𝐑ᴇʜɴᴀ 𝐇ᴀɪ 𝐓ᴏ🧐4ˢᵗ 𝐊ᴏ 𝐁ᴀᴀᴘ💞𝐁ᴏʟᴏ..🤪 @PROFESSOR_77XX 👻 :)`",
        "`Private Call Disconnected....4ˢᵗ➳𝐏ʀᴏғᴇssᴏʀ🍃 ɴᴇ ᴏᴘ ɢᴀɴᴅ ᴍᴀʀᴅɪ..🤣🤣🤣`",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
...
async def hak(client: Client, message: Message):
    ...
    await asyncio.sleep(2)
    await message.edit_text(
        "Targeted Account Hacked...!\n\n ✅ File has been successfully uploaded to my server @PROFESSOR_77XX.\nWhatsApp Database:\n`./DOWNLOADS/msgstore.db.crypt12`"
    )
